...
import com.atomcollide.purepicks.agent.agent.ExecutorAgent;
import com.atomcollide.purepicks.agent.agent.PlanningAgent;
...
import com.atomcollide.purepicks.agent.dto.SopRecallResponse;
import com.atomcollide.purepicks.model.req.AgentRequest;
import com.atomcollide.purepicks.service.AgentHandlerService;
import com.atomcollide.purepicks.service.SopRecallService;
...
public class PlanSolveHandlerImpl implements AgentHandlerService {
    ...
    public String handle(AgentContext agentContext, AgentRequest request) {
        ...
        int stepIdx = 0;
        int maxStepNum = purepicksConfig.getPlannerMaxSteps();
