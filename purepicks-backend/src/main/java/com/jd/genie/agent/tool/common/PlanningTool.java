...
import com.atomcollide.purepicks.agent.dto.Plan;
...
public class PlanningTool implements BaseTool {
    ...
    public String getDescription() {
        ...
        return purepicksConfig.getPlanToolDesc().isEmpty() ? desc : purepicksConfig.getPlanToolDesc();
    }

    @Override
    public Map<String, Object> toParams() {
        purepicksConfig purepicksConfig = SpringContextHolder.getApplicationContext().getBean(purepicksConfig.class);
        if (!purepicksConfig.getPlanToolParams().isEmpty()) {
            return purepicksConfig.getPlanToolParams();
        }
