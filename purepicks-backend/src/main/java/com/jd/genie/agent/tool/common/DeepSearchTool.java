...
import com.atomcollide.purepicks.agent.dto.DeepSearchRequest;
import com.atomcollide.purepicks.agent.dto.DeepSearchrResponse;
import com.atomcollide.purepicks.agent.dto.FileRequest;
...
public class DeepSearchTool implements BaseTool {
    ...
    public String getDescription() {
        ...
        return purepicksConfig.getDeepSearchToolDesc().isEmpty() ? desc : purepicksConfig.getDeepSearchToolDesc();
    }
    ...
    public Map<String, Object> toParams() {
        ...
        purepicksConfig purepicksConfig = SpringContextHolder.getApplicationContext().getBean(purepicksConfig.class);
        if (!purepicksConfig.getDeepSearchToolPamras().isEmpty()) {
            return purepicksConfig.getDeepSearchToolPamras();
        }
    ...
    public Object execute(Object input) {
        ...
        try {
            ...
            bingConfig.put("count", Integer.parseInt(purepicksConfig.getDeepSearchPageCount()));
    ...
    public CompletableFuture<String> callDeepSearchStream(DeepSearchRequest searchRequest) {
        ...
        try {
            ...
            String url = purepicksConfig.getDeepSearchUrl() + "/v1/tool/deepsearch";
            ...
            String[] interval = purepicksConfig.getMessageInterval().getOrDefault("search", "5,20").split(",");
                            ...
                            if (line.startsWith("data: ")) {
                                ...
                                if (searchResponse.getIsFinal()) {
                                    ...
                                    String fileDesc = searchResponse.getAnswer()
                                            .substring(0, Math.min(searchResponse.getAnswer().length(), purepicksConfig.getDeepSearchToolFileDescTruncateLen())) + "...";
                                    ...
                                    result = searchResponse.getAnswer().
                                            substring(0, Math.min(searchResponse.getAnswer().length(), purepicksConfig.getDeepSearchToolMessageTruncateLen()));
