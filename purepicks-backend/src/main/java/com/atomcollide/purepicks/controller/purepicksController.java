...
import com.atomcollide.purepicks.service.impl.AgentHandlerFactory;
...
public class purepicksController {
    ...
    private String handleOutputStyle(AgentRequest request) {
        ...
        Map<String, String> outputStyleMap = purepicksConfig.getOutputStylePrompts();
    ...
    private ToolCollection buildToolCollection(AgentContext agentContext, AgentRequest request) {
        ...
        if ("dataAgent".equals(request.getOutputStyle())) {
            ...
            // default tool
            List<String> agentToolList = Arrays.asList(purepicksConfig.getMultiAgentToolListMap()
        ...
        try {
            ...
            for (String mcpServer : purepicksConfig.getMcpServerUrlArr()) {
