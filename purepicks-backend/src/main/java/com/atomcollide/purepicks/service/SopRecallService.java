...
import com.atomcollide.purepicks.util.HttpUtils;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang3.StringUtils;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import com.atomcollide.purepicks.agent.dto.SopRecallResponse;
import com.atomcollide.purepicks.agent.dto.SopRecallRequest;
...
public class SopRecallService {
    ...
    public SopRecallResponse sopRecall(String requestId, String query) {
        try {
            String SOP_RECALL_URL = purepicksConfig.getAutoBotsKnowledgeUrl() + "/v1/tool/sopRecall";
