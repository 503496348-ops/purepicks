...
public class ReactImplAgent extends ReActAgent {
    ...
    public ReactImplAgent(AgentContext context) {
        ...
        setSystemPrompt(purepicksConfig.getReactSystemPromptMap().getOrDefault(promptKey, ToolCallPrompt.SYSTEM_PROMPT)
        ...
        setNextStepPrompt(purepicksConfig.getReactNextStepPromptMap().getOrDefault(nextPromptKey, ToolCallPrompt.NEXT_STEP_PROMPT)
                .replace("{{tools}}", toolPrompt.toString())
                .replace("{{query}}", context.getQuery())
                .replace("{{date}}", context.getDateInfo())
                .replace("{{basePrompt}}", context.getBasePrompt()));
        ...
        setMaxSteps(purepicksConfig.getReactMaxSteps());
        setLlm(new LLM(purepicksConfig.getReactModelName(), ""));
        setContext(context);
