...
import com.atomcollide.purepicks.agent.dto.DataAnalysisRequest;
import com.atomcollide.purepicks.agent.dto.DataAnalysisResponse;
...
public class DataAnalysisTool implements BaseTool {
    ...
    public String getDescription() {
        ...
        StringBuilder description = new StringBuilder(purepicksConfig.getDataAnalysisToolDesc().isEmpty() ? desc : purepicksConfig.getDataAnalysisToolDesc());
    ...
    public Map<String, Object> toParams() {
        purepicksConfig purepicksConfig = SpringContextHolder.getApplicationContext().getBean(purepicksConfig.class);
        if (!purepicksConfig.getDataAnalysisToolPamras().isEmpty()) {
            return purepicksConfig.getDataAnalysisToolPamras();
        }
    ...
    public CompletableFuture<String> callAutoAnalysisStream(DataAnalysisRequest analysisRequest) {
        ...
        try {
            ...
            purepicksConfig duccConfig = applicationContext.getBean(purepicksConfig.class);
            // 使用默认的自动分析API URL
