...
public class CodeInterpreterTool implements BaseTool {
    ...
    public String getDescription() {
        ...
        return purepicksConfig.getCodeAgentDesc().isEmpty() ? desc : purepicksConfig.getCodeAgentDesc();
    }
    ...
    public Map<String, Object> toParams() {
        ...
        purepicksConfig purepicksConfig = SpringContextHolder.getApplicationContext().getBean(purepicksConfig.class);
        if (!purepicksConfig.getCodeAgentPamras().isEmpty()) {
            return purepicksConfig.getCodeAgentPamras();
        }
    ...
    public CompletableFuture<String> callCodeAgentStream(CodeInterpreterRequest codeRequest) {
        ...
        try {
            ...
            String url = purepicksConfig.getCodeInterpreterUrl() + "/v1/tool/code_interpreter";
