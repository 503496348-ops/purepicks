...
import com.atomcollide.purepicks.agent.dto.CodeInterpreterRequest;
...
public class ReportTool implements BaseTool {
    ...
    public String getDescription() {
        ...
        return purepicksConfig.getReportToolDesc().isEmpty() ? desc : purepicksConfig.getReportToolDesc();
    }
    ...
    public Map<String, Object> toParams() {
        ...
        purepicksConfig purepicksConfig = SpringContextHolder.getApplicationContext().getBean(purepicksConfig.class);
        if (!purepicksConfig.getReportToolPamras().isEmpty()) {
            return purepicksConfig.getReportToolPamras();
        }
    ...
    public CompletableFuture<String> callCodeAgentStream(CodeInterpreterRequest codeRequest) {
        ...
        try {
            ...
            String url = purepicksConfig.getCodeInterpreterUrl() + "/v1/tool/report";
            ...
            String[] interval = purepicksConfig.getMessageInterval().getOrDefault("report", "1,4").split(",");
