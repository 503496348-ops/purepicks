...
import com.atomcollide.purepicks.agent.llm.LLMSettings;
...
public class purepicksConfig {
	...
	@Value("${autobots.autoagent.purepicks_sop_prompt:}")
	private String purepicksSopPrompt;

    @Value("${autobots.autoagent.purepicks_base_prompt:}")
    private String purepicksBasePrompt;
