...
public class DataAgentConstants {
    ...
    public static final String SCHEMA_COLLECTION_NAME = "purepicks_model_schema";
    //es存储列值索引名称
    public static final String COLUMN_VALUE_ES_INDEX = "purepicks_model_column_value";
    //es 列值索引mapping
    public static final String COLUMN_VALUE_ES_MAPPING = """
            {
              "aliases": {
                "purepicks_model_column_value_alias": {
                }
              },
              "mappings": {
                "properties": {
