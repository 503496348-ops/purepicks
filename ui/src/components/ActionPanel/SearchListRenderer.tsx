...
const SearchListItemComponent: purepicksType.FC<SearchListItem> = React.memo(({ name, pageContent, url }) => (
 ...
 * @param list - 搜索结果列表
 */
const SearchListRenderer: purepicksType.FC<SearchListRendererProps> = React.memo(({ list }) => (
