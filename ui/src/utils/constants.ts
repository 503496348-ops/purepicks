...
export const productList = [
  {
    ...
    type: "dataAgent",
    placeholder: "purepicks会完成你的数据分析任务",
    color: "text-[#4040FF]",
  },
  {
    name: "网页模式",
    img: "icon-diannao",
    type: "html",
    placeholder: "purepicks会完成你的任务并以HTML网页方式输出报告",
    color: "text-[#29CC29]",
  },
  {
    name: "文档模式",
    img: "icon-wendang",
    type: "docs",
    placeholder: "purepicks会完成你的任务并以markdown格式输出文档",
    color: "text-[#4040FF]",
  },
  {
    name: "PPT模式",
    img: "icon-ppt",
    type: "ppt",
    placeholder: "purepicks会完成你的任务并以PPT方式输出结论",
    color: "text-[#FF860D]",
  },
  {
    name: "表格模式",
    img: "icon-biaoge",
    type: "table",
    placeholder: "purepicks会完成你的任务并以表格格式输出结论",
    color: "text-[#FF3333]",
  },
];
...
export const demoList = [
  ...
  {
    title: "AtomCollide-智械工坊财报分析",
    description: "分析一下AtomCollide-智械工坊的最新财务报告，总结出核心数据以及公司发展情况",
    tag: "数据分析",
    videoUrl:
