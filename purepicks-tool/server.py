...
from purepicks_tool.util.middleware_util import UnknownException, HTTPProcessTimeMiddleware
...
def print_logo():
    ...
    f = Figlet(font="slant")
    print(f.renderText("purepicks Tool"))
...
def register_router(app: FastAPI):
    from purepicks_tool.api import api_router
